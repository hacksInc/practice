<?php
/**
 *  Admin/Announce/Message/Dialog/Create/Confirm.php
 *
 *  @author     {$author}
 *  @package    Pp
 *  @version    $Id$
...
/**
 *  admin_announce_message_dialog_create_confirm Form implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_Form_AdminAnnounceMessageDialogCreateConfirm extends Pp_Form_AdminAnnounceMessageDialog
{
    /**
     *  @access private
...
/**
 *  admin_announce_message_dialog_create_confirm action implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_Action_AdminAnnounceMessageDialogCreateConfirm extends Pp_AdminActionClass
{
    /**
     *  preprocess of admin_announce_message_dialog_create_confirm Action.
     *
     *  @access public
    ...
    function perform()
    {
        ...
        return 'admin_announce_message_dialog_create_confirm';
    }
}
