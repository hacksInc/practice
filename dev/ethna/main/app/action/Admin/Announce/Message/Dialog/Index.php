...
/** admin_announce_message_dialog_* で共通のアクションフォーム定義 */
class Pp_Form_AdminAnnounceMessageDialog extends Pp_AdminActionForm
{
    /**
     * コンストラクタ
     */
	...
	{
		$session_key = 'admin_announce_message_dialog_lu';
...
/**
 *  admin_announce_message_dialog_index Form implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_Form_AdminAnnounceMessageDialogIndex extends Pp_Form_AdminAnnounceMessageDialog
{
    /**
     *  @access private
...
/**
 *  admin_announce_message_dialog_index action implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_Action_AdminAnnounceMessageDialogIndex extends Pp_AdminActionClass
{
    /**
     *  preprocess of admin_announce_message_dialog_index Action.
     *
     *  @access public
...
*/
    ...
    function perform()
    {
        return 'admin_announce_message_dialog_index';
    }
}
