...
/** admin_announce_message_error_* で共通のアクションフォーム定義 */
class Pp_Form_AdminAnnounceMessageError extends Pp_AdminActionForm
{
	/**
	 * コンストラクタ
	 */
...
//				'max'         => 50000,            // Maximum value
	...
	{
		$session_key = 'admin_announce_message_error_lu';
...
/**
 *  admin_announce_message_error_index Form implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_Form_AdminAnnounceMessageErrorIndex extends Pp_Form_AdminAnnounceMessageError
{
    /**
     *  @access private
...
/**
 *  admin_announce_message_error_index action implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_Action_AdminAnnounceMessageErrorIndex extends Pp_AdminActionClass
{
    /**
     *  preprocess of admin_announce_message_error_index Action.
     *
     *  @access public
...
*/
    ...
    function perform()
    {
        return 'admin_announce_message_error_index';
    }
}
