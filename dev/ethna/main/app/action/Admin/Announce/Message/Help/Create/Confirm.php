<?php
/**
 *  Admin/Announce/Message/Help/Create/Confirm.php
 *
 *  @author     {$author}
 *  @package    Pp
 *  @version    $Id$
...
/**
 *  admin_announce_message_help_create_confirm Form implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_Form_AdminAnnounceMessageHelpCreateConfirm extends Pp_Form_AdminAnnounceMessageHelp
{
    /**
     *  @access private
...
/**
 *  admin_announce_message_help_create_confirm action implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_Action_AdminAnnounceMessageHelpCreateConfirm extends Pp_AdminActionClass
{
    /**
     *  preprocess of admin_announce_message_help_create_confirm Action.
     *
     *  @access public
    ...
    function perform()
    {
        ...
        return 'admin_announce_message_help_create_confirm';
    }
}
