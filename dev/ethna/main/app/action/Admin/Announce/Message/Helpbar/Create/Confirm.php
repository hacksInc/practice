...
/**
 *  admin_announce_message_helpbar_create_confirm Form implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_Form_AdminAnnounceMessageHelpbarCreateConfirm extends Pp_Form_AdminAnnounceMessageHelpbar
{
    /**
     *  @access private
...
/**
 *  admin_announce_message_helpbar_create_confirm action implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_Action_AdminAnnounceMessageHelpbarCreateConfirm extends Pp_AdminActionClass
{
    /**
     *  preprocess of admin_announce_message_helpbar_create_confirm Action.
     *
     *  @access public
    ...
    function perform()
    {
        ...
        return 'admin_announce_message_helpbar_create_confirm';
    }
}
