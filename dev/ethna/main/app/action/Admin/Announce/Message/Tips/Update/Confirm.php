...
/**
 *  admin_announce_message_tips_update_confirm Form implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_Form_AdminAnnounceMessageTipsUpdateConfirm extends Pp_Form_AdminAnnounceMessageTips
{
    /**
     *  @access private
...
/**
 *  admin_announce_message_tips_update_confirm action implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_Action_AdminAnnounceMessageTipsUpdateConfirm extends Pp_AdminActionClass
{
    /**
     *  preprocess of admin_announce_message_tips_update_confirm Action.
     *
     *  @access public
    ...
    function perform()
    {
        ...
        $base_tip_id = $this->af->get('base_tip_id');
        ...
        return 'admin_announce_message_tips_update_confirm';
    }
}
