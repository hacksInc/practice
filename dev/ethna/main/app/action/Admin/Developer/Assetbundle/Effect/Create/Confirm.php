...
/**
 *  admin_developer_assetbundle_effect_create_confirm Form implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_Form_AdminDeveloperAssetbundleEffectCreateConfirm extends Pp_Form_AdminDeveloperAssetbundleEffect
{
    /**
     *  @access private
...
/**
 *  admin_developer_assetbundle_effect_create_confirm action implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_Action_AdminDeveloperAssetbundleEffectCreateConfirm extends Pp_Action_AdminDeveloperAssetbundle
{
    /**
     *  preprocess of admin_developer_assetbundle_effect_create_confirm Action.
     *
     *  @access public
    ...
    function prepare()
    {
		...
		foreach (array(
			...
			if ($assetbundle_m->getMasterAssetBundleByUniqueKey(
				1, 'effect', 'effect', $splitted['version']
			)) {
    ...
    function perform()
    {
        return 'admin_developer_assetbundle_effect_create_confirm';
    }
}
