<?php
/**
 *  Admin/Developer/Assetbundle/Effect/Update/Confirm.php
 *
 *  @author     {$author}
 *  @package    Pp
 *  @version    $Id$
...
/**
 *  admin_developer_assetbundle_effect_update_confirm Form implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_Form_AdminDeveloperAssetbundleEffectUpdateConfirm extends Pp_Form_AdminDeveloperAssetbundleEffect
{
    /**
     *  @access private
...
/**
 *  admin_developer_assetbundle_effect_update_confirm action implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_Action_AdminDeveloperAssetbundleEffectUpdateConfirm extends Pp_Action_AdminDeveloperAssetbundle
{
    /**
     *  preprocess of admin_developer_assetbundle_effect_update_confirm Action.
     *
     *  @access public
    ...
    function perform()
    {
        return 'admin_developer_assetbundle_effect_update_confirm';
    }
}
