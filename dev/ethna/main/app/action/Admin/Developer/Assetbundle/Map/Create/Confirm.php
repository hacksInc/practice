<?php
/**
 *  Admin/Developer/Assetbundle/Map/Create/Confirm.php
 *
 *  @author     {$author}
 *  @package    Pp
 *  @version    $Id$
...
/**
 *  admin_developer_assetbundle_map_create_confirm Form implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_Form_AdminDeveloperAssetbundleMapCreateConfirm extends Pp_Form_AdminDeveloperAssetbundleMap
{
    /**
     *  @access private
...
/**
 *  admin_developer_assetbundle_map_create_confirm action implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_Action_AdminDeveloperAssetbundleMapCreateConfirm extends Pp_Action_AdminDeveloperAssetbundle
{
    /**
     *  preprocess of admin_developer_assetbundle_map_create_confirm Action.
     *
     *  @access public
    ...
    function prepare()
    {
		...
		foreach (array(
			...
			// DBに登録されていないことを確認
			$dir = $assetbundle_m->getMapDir($splitted['file_name']);
    ...
    function perform()
    {
        return 'admin_developer_assetbundle_map_create_confirm';
    }
}
