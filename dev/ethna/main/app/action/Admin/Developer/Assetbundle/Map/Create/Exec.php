<?php
/**
 *  Admin/Developer/Assetbundle/Map/Create/Exec.php
 *
 *  @author     {$author}
 *  @package    Pp
 *  @version    $Id$
...
/**
 *  admin_developer_assetbundle_map_create_exec Form implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_Form_AdminDeveloperAssetbundleMapCreateExec extends Pp_Form_AdminDeveloperAssetbundleMap
{
    /**
     *  @access private
...
/**
 *  admin_developer_assetbundle_map_create_exec action implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_Action_AdminDeveloperAssetbundleMapCreateExec extends Pp_Action_AdminDeveloperAssetbundle
{
    /**
     *  preprocess of admin_developer_assetbundle_map_create_exec Action.
     *
     *  @access public
    ...
    function perform()
    {
		...
		$dir = $assetbundle_m->getMapDir($cache_contents['file_name']);
		...
		// ログ
		$admin_m->addAdminOperationLog('/developer/assetbundle', 'map_log', array_merge(
			array(
        ...
        return 'admin_developer_assetbundle_map_create_exec';
    }
}
