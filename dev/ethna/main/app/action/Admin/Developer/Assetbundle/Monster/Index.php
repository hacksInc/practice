...
/** admin_developer_assetbundle_monster_* で共通のアクションフォーム定義 */
class Pp_Form_AdminDeveloperAssetbundleMonster extends Pp_Form_AdminDeveloperAssetbundle
{
	/**
	...
	function checkAssetbundleFile($name)
	{
		...
		// モンスターIDを確認
		$monster_id = substr($splitted['file_name'], strlen('monster_atlas_'));
		if (!preg_match('/^[0-9]+$/', $monster_id)) {
...
/**
 *  admin_developer_assetbundle_monster_index Form implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_Form_AdminDeveloperAssetbundleMonsterIndex extends Pp_Form_AdminDeveloperAssetbundleMonster
{
    /**
     *  @access private
...
/**
 *  admin_developer_assetbundle_monster_index action implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_Action_AdminDeveloperAssetbundleMonsterIndex extends Pp_AdminActionClass
{
    /**
     *  preprocess of admin_developer_assetbundle_monster_index Action.
     *
     *  @access public
...
*/
    ...
    function perform()
    {
        return 'admin_developer_assetbundle_monster_index';
    }
}
