...
/**
 *  admin_developer_assetbundle_others_create_confirm Form implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_Form_AdminDeveloperAssetbundleOthersCreateConfirm extends Pp_Form_AdminDeveloperAssetbundleOthers
{
    /**
     *  @access private
...
/**
 *  admin_developer_assetbundle_others_create_confirm action implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_Action_AdminDeveloperAssetbundleOthersCreateConfirm extends Pp_Action_AdminDeveloperAssetbundle
{
    /**
     *  preprocess of admin_developer_assetbundle_others_create_confirm Action.
     *
     *  @access public
    ...
    function prepare()
    {
		...
		foreach (array(
			...
			if ($assetbundle_m->getMasterAssetBundleByUniqueKey(
				1, 'others', $splitted['file_name'], $splitted['version']
			)) {
    ...
    function perform()
    {
        return 'admin_developer_assetbundle_others_create_confirm';
    }
}
