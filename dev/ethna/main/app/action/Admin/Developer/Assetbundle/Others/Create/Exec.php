<?php
/**
 *  Admin/Developer/Assetbundle/Others/Create/Exec.php
 *
 *  @author     {$author}
 *  @package    Pp
 *  @version    $Id$
...
/**
 *  admin_developer_assetbundle_others_create_exec Form implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_Form_AdminDeveloperAssetbundleOthersCreateExec extends Pp_Form_AdminDeveloperAssetbundleOthers
{
    /**
     *  @access private
...
/**
 *  admin_developer_assetbundle_others_create_exec action implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_Action_AdminDeveloperAssetbundleOthersCreateExec extends Pp_Action_AdminDeveloperAssetbundle
{
	/**
     *  preprocess of admin_developer_assetbundle_others_create_exec Action.
     *
     *  @access public
    ...
    function perform()
    {
        ...
        return 'admin_developer_assetbundle_others_create_exec';
    }
}
