...
/** admin_developer_assetbundle_others_* で共通のアクションフォーム定義 */
class Pp_Form_AdminDeveloperAssetbundleOthers extends Pp_Form_AdminDeveloperAssetbundle
{
	/**
	...
	function checkAssetbundleFile($name)
	{
		...
		/*
		// ファイル名を確認
		if (strcmp($splitted['file_name'], 'others') !== 0) {
...
/**
 *  admin_developer_assetbundle_others_index Form implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_Form_AdminDeveloperAssetbundleOthersIndex extends Pp_Form_AdminDeveloperAssetbundleOthers
{
    /**
     *  @access private
...
/**
 *  admin_developer_assetbundle_others_index action implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_Action_AdminDeveloperAssetbundleOthersIndex extends Pp_AdminActionClass
{
    /**
     *  preprocess of admin_developer_assetbundle_others_index Action.
     *
     *  @access public
...
*/
    ...
    function perform()
    {
        return 'admin_developer_assetbundle_others_index';
    }
}
