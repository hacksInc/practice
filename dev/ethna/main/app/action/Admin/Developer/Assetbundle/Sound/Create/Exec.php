<?php
/**
 *  Admin/Developer/Assetbundle/Sound/Create/Exec.php
 *
 *  @author     {$author}
 *  @package    Pp
 *  @version    $Id$
...
/**
 *  admin_developer_assetbundle_sound_create_exec Form implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_Form_AdminDeveloperAssetbundleSoundCreateExec extends Pp_Form_AdminDeveloperAssetbundleSound
{
    /**
     *  @access private
...
/**
 *  admin_developer_assetbundle_sound_create_exec action implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_Action_AdminDeveloperAssetbundleSoundCreateExec extends Pp_Action_AdminDeveloperAssetbundle
{
    /**
     *  preprocess of admin_developer_assetbundle_sound_create_exec Action.
     *
     *  @access public
    ...
    function perform()
    {
		...
		$dir = $assetbundle_m->getSoundDir($cache_contents['file_name']);
		...
		// ログ
		$admin_m->addAdminOperationLog('/developer/assetbundle', 'sound_log', array_merge(
			array(
		...
		return 'admin_developer_assetbundle_sound_create_exec';
    }
}
