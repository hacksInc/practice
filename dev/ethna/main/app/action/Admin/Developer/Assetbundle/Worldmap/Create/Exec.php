<?php
/**
 *  Admin/Developer/Assetbundle/Worldmap/Create/Exec.php
 *
 *  @author     {$author}
 *  @package    Pp
 *  @version    $Id$
...
/**
 *  admin_developer_assetbundle_worldmap_create_exec Form implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_Form_AdminDeveloperAssetbundleWorldmapCreateExec extends Pp_Form_AdminDeveloperAssetbundleWorldmap
{
    /**
     *  @access private
...
/**
 *  admin_developer_assetbundle_worldmap_create_exec action implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_Action_AdminDeveloperAssetbundleWorldmapCreateExec extends Pp_Action_AdminDeveloperAssetbundle
{
	/**
     *  preprocess of admin_developer_assetbundle_worldmap_create_exec Action.
     *
     *  @access public
    ...
    function perform()
    {
		...
		// ログ
		$admin_m->addAdminOperationLog('/developer/assetbundle', 'worldmap_log', array_merge(
			array(
        ...
        return 'admin_developer_assetbundle_worldmap_create_exec';
    }
}
