<?php
/**
 *  Admin/Developer/Gacha/Weight/Category/Create/Exec.php
 *
 *  @author     {$author}
 *  @package    Pp
 *  @version    $Id$
...
/**
 *  admin_developer_gacha_weight_category_create_exec Form implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_Form_AdminDeveloperGachaWeightCategoryCreateExec extends Pp_Form_AdminDeveloperGacha
{
    /**
     *  @access private
...
/**
 *  admin_developer_gacha_weight_category_create_exec action implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_Action_AdminDeveloperGachaWeightCategoryCreateExec extends Pp_AdminActionClass
{
    /**
     *  preprocess of admin_developer_gacha_weight_category_create_exec Action.
     *
     *  @access public
...
//		$db->begin();
		...
		// DBへ登録
		$ret = $shop_m->insertGachaCategory($columns);
...
//		$db->commit();
        ...
        return 'admin_developer_gacha_weight_category_create_exec';
    }
}
