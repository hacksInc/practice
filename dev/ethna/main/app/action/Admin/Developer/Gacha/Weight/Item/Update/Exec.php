<?php
/**
 *  Admin/Developer/Gacha/Weight/Item/Update/Exec.php
 *
 *  @author     {$author}
 *  @package    Pp
 *  @version    $Id$
...
/**
 *  admin_developer_gacha_weight_item_update_exec Form implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_Form_AdminDeveloperGachaWeightItemUpdateExec extends Pp_Form_AdminDeveloperGacha
{
    /**
     *  @access private
...
/**
 *  admin_developer_gacha_weight_item_update_exec action implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_Action_AdminDeveloperGachaWeightItemUpdateExec extends Pp_AdminActionClass
{
    /**
     *  preprocess of admin_developer_gacha_weight_item_update_exec Action.
     *
     *  @access public
...
//		$db->begin();
		...
		// DBへ登録
		$ret = $shop_m->updateGachaItemList($columns);
...
//		$db->commit();
        ...
        return 'admin_developer_gacha_weight_item_update_exec';
    }
}
