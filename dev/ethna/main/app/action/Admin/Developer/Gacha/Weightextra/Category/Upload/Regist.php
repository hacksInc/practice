<?php
/**
 *  Admin/Developer/Gacha/Weightextra/Category/Upload/Regist.php
 *
 *  @author     {$author}
 *  @package    Pp
 *  @version    $Id$
...
/**
 *  admin_developer_gacha_weightextra_category_upload_regist Form implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_Form_AdminDeveloperGachaWeightextraCategoryUploadRegist extends Pp_Form_AdminDeveloperGacha
{
    /**
     *  @access private
...
/**
 *  admin_developer_gacha_weightextra_category_upload_regist action implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_Action_AdminDeveloperGachaWeightextraCategoryUploadRegist extends Pp_AdminActionClass
{
    /**
     *  preprocess of admin_developer_gacha_weightextra_category_upload_regist Action.
     *
     *  @access public
...
//		            . 'm_gacha_category/' . $gacha_id;
    ...
    function perform()
    {
//      return 'admin_developer_gacha_weightextra_category_upload_regist';
