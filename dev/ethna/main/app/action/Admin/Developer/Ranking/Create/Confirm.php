<?php
/**
 *  Admin/Developer/Ranking/Create/Confirm.php
 *
 *  @author     {$author}
 *  @package    Pp
 *  @version    $Id$
...
/**
 *  admin_developer_ranking_create_confirm Form implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_Form_AdminDeveloperRankingCreateConfirm extends Pp_Form_AdminDeveloperRanking
{
    /**
     *  @access private
...
/**
 *  admin_developer_ranking_create_confirm action implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_Action_AdminDeveloperRankingCreateConfirm extends Pp_AdminActionClass
{
    /**
     *  preprocess of admin_developer_ranking_create_confirm Action.
     *
     *  @access public
    ...
    function perform()
    {
        return 'admin_developer_ranking_create_confirm';
    }
}
