<?php
/**
 *  Admin/Developer/Ranking/Create/Exec.php
 *
 *  @author     {$author}
 *  @package    Pp
 *  @version    $Id$
...
/**
 *  admin_developer_ranking_create_exec Form implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_Form_AdminDeveloperRankingCreateExec extends Pp_Form_AdminDeveloperRanking
{
    /**
     *  @access private
...
/**
 *  admin_developer_ranking_create_exec action implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_Action_AdminDeveloperRankingCreateExec extends Pp_AdminActionClass
{
    /**
     *  preprocess of admin_developer_ranking_create_exec Action.
     *
     *  @access public
    ...
    function prepare()
    {
		...
		$ret = parent::prepare();
		if ($ret) {
			return 'admin_developer_ranking_create_input';
		}
    ...
    function perform()
    {
		...
		$ret = $ranking_m->insertMasterRanking( $columns );
		if( !$ret || Ethna::isError( $ret ))
		{
			return 'admin_error_500';
		}
        return 'admin_developer_ranking_create_exec';
    }
}
