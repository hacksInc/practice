<?php
/**
 *  Admin/Developer/Ranking/Prize/Create/Exec.php
 *
 *  @author     {$author}
 *  @package    Pp
 *  @version    $Id$
...
/**
 *  admin_developer_ranking_prize_create_exec Form implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_Form_AdminDeveloperRankingPrizeCreateExec extends Pp_Form_AdminDeveloperRanking
{
    /**
     *  @access private
...
/**
 *  admin_developer_ranking_prize_create_exec action implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_Action_AdminDeveloperRankingPrizeCreateExec extends Pp_AdminActionClass
{
    /**
     *  preprocess of admin_developer_ranking_prize_create_exec Action.
     *
     *  @access public
    ...
    function perform()
    {
		...
		return 'admin_developer_ranking_prize_create_exec';
    }
}
