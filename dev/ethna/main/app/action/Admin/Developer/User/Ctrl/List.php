<?php
/**
 *  Admin/Developer/User/CtrlList.php
 *
 *  @author	 {$author}
 *  @package	Pp
 *  @version	$Id$
...
/**
 *  admin_developer_user_ctrl_list Form implementation.
 *
 *  @author	 {$author}
 *  @access	 public
 *  @package	Pp
 */
class Pp_Form_AdminDeveloperUserCtrlList extends Pp_AdminActionForm
{
	/**
	 *  @access private
 ...
 *  @package Pp
 */
class Pp_Action_AdminDeveloperUserCtrlList extends Pp_AdminActionClass
{
	/**
...
*/
	...
	/**
	 *  admin_developer_user_ctrl_list action implementation.
	 *
	 *  @access public
		...
		switch ($by) {
			case 'id':
				...
				if (!$base) {
					...
					return 'admin_developer_user_ctrl_select';
				}
				break;
			...
			case 'name':
				...
				if ($bases_cnt == 1) {
					...
					return 'admin_developer_user_ctrl_name';
				} else {
					$this->af->setApp('err_mes', "検索ユーザが見つかりませんでした");
					return 'admin_developer_user_ctrl_select';
				}
			...
			case 'term':
				...
				if ($bases_cnt == 1) {
					...
					$this->af->setApp('bases', $bases);
					return 'admin_developer_user_ctrl_term';
				} else {
					$this->af->setApp('err_mes', "検索ユーザが見つかりませんでした");
					return 'admin_developer_user_ctrl_select';
				}
