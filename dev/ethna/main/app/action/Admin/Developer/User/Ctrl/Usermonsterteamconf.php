<?php
/**
 *  Admin/Developer/User/Ctrl/Usermonsterteamconf.php
 *
 *  @author     {$author}
 *  @package    Pp
 *  @version    $Id$
...
/**
 *  admin_developer_user_ctrl_usermonsterteamconf Form implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_Form_AdminDeveloperUserCtrlUsermonsterteamconf extends Pp_AdminActionForm
{
    /**
     *  @access private
...
/**
 *  admin_developer_user_ctrl_usermonsterteamconf action implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_Action_AdminDeveloperUserCtrlUsermonsterteamconf extends Pp_AdminActionClass
{
    /**
...
*/
    ...
    function perform()
    {
        ...
        return 'admin_developer_user_ctrl_usermonsterteamconf';
    }
}
