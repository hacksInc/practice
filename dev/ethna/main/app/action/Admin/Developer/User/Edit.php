...
/**
 *  admin_developer_user_edit Form implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_Form_AdminDeveloperUserEdit extends Pp_AdminActionForm
{
    /**
     *  @access private
 ...
 *  @package    Pp
 */
class Pp_Action_AdminDeveloperUserEdit extends Pp_AdminActionClass
{
    /**
...
*/
    ...
    function perform()
    {
		...
		if ((count($primary_keys) == 1) && ($primary_keys[0] == 'user_id')) {
			// 主キーがuser_idのみのテーブルの場合
		    return 'admin_developer_user_edit_one';
		}
		
        return 'admin_developer_user_edit';
    }
}
