<?php
/**
 *  Admin/Kpi/Device/Info/Base.php
 *
 *  @author	 	{$author}
 *  @package	Pp
 *  @version	$Id$
...
require_once 'Pp_AdminClientManager.php';

class Pp_Form_AdminKpiDeviceInfoBase extends Pp_AdminActionForm
{
...
class Pp_Action_AdminKpiDeviceInfoBase extends Pp_AdminActionClass
{
