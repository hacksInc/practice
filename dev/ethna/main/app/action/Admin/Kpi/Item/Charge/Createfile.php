<?php
/**
 *  Admin/Kpi/Item/Charge/Createfile.php
 *
 *  @author     {$author}
 *  @package    Pp
 *  @version    $Id$
...
/**
 *  admin_log_kpi_item_charge_createfile Form implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_Form_AdminKpiItemChargeCreatefile extends Pp_Form_AdminKpiItemCharge
{
    /**
     *  @access private
...
/**
 *  admin_kpi_item_charge_createfile action implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
...
class Pp_Action_AdminKpiItemChargeCreatefile extends Pp_AdminActionClass
{
...
//        $date_to = $this->af->get('search_date_to');
       ...
       if ($kpi_item_charge_count == 0) {
        ...
        $res = $kpiview_m->createCsvFileKpiItemChargeRate($kpi_item_charge_data['data'], $kpi_item_charge_sum_data);
        if ($res === false){
            $this->af->setApp('code', 400);
