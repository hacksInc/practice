<?php
/**
 *  Admin/Kpi/Item/Sales/Createfile.php
 *
 *  @author	 	$author}
 *  @access	 	public
 *  @package	Pp
...
/**
 *  admin_kpi_item_sales_createfile Form implementation.
 *
 *  @author	 	{$author}
 *  @access	 	public
 *  @package	Pp
 */
class Pp_Form_AdminKpiItemSalesCreatefile extends Pp_Form_AdminKpiItemSalesBase
{
	var $form = array(
 ...
 *  @package	Pp
 */
class Pp_Action_AdminKpiItemSalesCreatefile extends Pp_Action_AdminKpiItemSalesBase
{
	...
	public function perform()
	{
		...
		$file_name = $kpiusershop_m->{$method['csv']}($list);
