...
/**
 *  admin_kpi_user_area_progress_index Form implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_Form_AdminKpiUserAreaProgressIndex extends Pp_Form_AdminKpiUserAreaProgress
{
	/**
	 *  @access private
...
/**
 *  admin_kpi_user_area_progress_index action implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_Action_AdminKpiUserAreaProgressIndex extends Pp_AdminActionClass
{
	/**
