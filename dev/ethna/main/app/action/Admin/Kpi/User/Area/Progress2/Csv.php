<?php
/**
 *  Admin/Kpi/User/Area/Progress2/Csv.php
 *
 *  @author     {$author}
 *  @package    Pp
 *  @version    $Id$
...
/**
 *  admin_kpi_user_area_progress2_csv Form implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_Form_AdminKpiUserAreaProgress2Csv extends Pp_Form_AdminKpiUserAreaProgress2
{
	/**
	 *  @access private
 ...
 *  @package    Pp
 */
class Pp_Action_AdminKpiUserAreaProgress2Csv extends Pp_AdminActionClass
{
	/**
