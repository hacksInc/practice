<?php
/**
 *  Admin/Kpi/User/Mission/Createfile.php
 *
 *  @author	 	$author}
 *  @access	 	public
 *  @package	Pp
...
/**
 *  admin_kpi_user_mission_createfile Form implementation.
 *
 *  @author	 	{$author}
 *  @access	 	public
 *  @package	Pp
 */
class Pp_Form_AdminKpiUserMissionCreatefile extends Pp_Form_AdminKpiUserMissionBase
{
	var $form = array(
...
/**
 *  admin_kpi_user_mission_createfile action implementation.
 *
 *  @author	 	{$author}
 *  @access	 	public
 *  @package	Pp
 */
class Pp_Action_AdminKpiUserMissionCreatefile extends Pp_Action_AdminKpiUserMissionBase
{
	...
	public function perform()
	{
		...
		$count = $kpiusermission_m->getCount($search_params);
		...
		$list = $this->convertCsv($kpiusermission_m->getList($search_params));

		$file_name = $kpiusermission_m->createCsv($list);
