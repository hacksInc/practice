<?php
/**
 *  Admin/Log/Cs/Accounting/Createfile.php
 *
 *  @author     {$author}
 *  @package    Pp
 *  @version    $Id$
...
/** admin_log_cs_accounting_* で共通のアクションフォーム定義 */
	/*class Pp_Form_AdminLogCsAccountingCreatefile extends Pp_Form_AdminLogCsAccounting
	 {
	}*/

/**
 *  admin_log_cs_accounting_createfile Form implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
...
/**
 *  admin_log_cs_accounting_createfile action implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_Action_AdminLogCsAccountingCreatefile extends Pp_AdminActionClass
{
	const MAX_PAGE_DATA_COUNT = '100';
	const MAX_DATA_COUNT = '10000';

	/**
	 *  preprocess of admin_log_cs_accounting_createfile Action.
	 *
	 *  @access public
	...
	function perform()
	{
		...
		$accounting_log_data = $logdata_view_m->getAccountingLogData($search_params);
		$res = $logdata_view_m->createCsvFileAccountingLogData($accounting_log_data['data']);
		if ($res === false){
			$this->af->setApp('code', 400);
