<?php
/**
 *  Admin/Log/Cs/Area/Createfile.php
 *
 *  @author     {$author}
 *  @package    Pp
 *  @version    $Id$
...
/** admin_log_cs_area_* で共通のアクションフォーム定義 */
	/*class Pp_Form_AdminLogCsAreaCreatefile extends Pp_Form_AdminLogCsArea
	 {
	}*/

/**
 *  admin_log_cs_area_createfile Form implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
...
/**
 *  admin_log_cs_area_createfile action implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_Action_AdminLogCsAreaCreatefile extends Pp_AdminActionClass
{
	const MAX_PAGE_DATA_COUNT = '100';
	const MAX_DATA_COUNT = '10000';

	/**
	 *  preprocess of admin_log_cs_area_createfile Action.
	 *
	 *  @access public
	...
	function perform()
	{
		...
		$area_log_data = $logdata_view_m->getAreaLogData($search_params);
		$res = $logdata_view_m->createCsvFileAreaLogData($area_log_data['data']);
		if ($res === false){
			$this->af->setApp('code', 400);
