<?php
/**
 *  Admin/Log/Cs/Character/Createfile.php
 *
 *  @author     {$author}
 *  @package    Pp
 *  @version    $Id$
...
/** admin_log_cs_character_* で共通のアクションフォーム定義 */
	/*class Pp_Form_AdminLogCsCharacterCreatefile extends Pp_Form_AdminLogCsCharacter
	 {
	}*/

/**
 *  admin_log_cs_character_createfile Form implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
...
/**
 *  admin_log_cs_character_createfile action implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_Action_AdminLogCsCharacterCreatefile extends Pp_AdminActionClass
{
	const MAX_PAGE_DATA_COUNT = '100';
	const MAX_DATA_COUNT = '10000';

	/**
	 *  preprocess of admin_log_cs_character_createfile Action.
	 *
	 *  @access public
	...
	function perform()
	{
		...
		$character_log_data = $logdata_view_m->getCharacterLogData($search_params);
		$res = $logdata_view_m->createCsvFileCharacterLogData($character_log_data['data']);
		if ($res === false){
			$this->af->setApp('code', 400);
