<?php
/**
 *  Admin/Log/Cs/Gacha/Createfile.php
 *
 *  @author     {$author}
 *  @package    Pp
 *  @version    $Id$
...
/**
 *  admin_log_cs_gacha_createfile Form implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_Form_AdminLogCsGachaCreatefile extends Pp_Form_AdminLogCsGacha
{
	/**
	 *  @access private
...
/**
 *  admin_log_cs_gacha_createfile action implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_Action_AdminLogCsGachaCreatefile extends Pp_Action_AdminLogCsIndex
{
	...
	/**
	 *  preprocess of admin_log_cs_gacha_createfile Action.
	 *
	 *  @access public
	...
	function perform()
	{
		...
		$gacha_log_data = $logdata_view_m->getGachaLogData($search_params);
		...
		$res = $logdata_view_m->createCsvFileGachaLogData($gacha_log_data['data']);
		if ($res === false){
			$this->af->setApp('code', 400);
