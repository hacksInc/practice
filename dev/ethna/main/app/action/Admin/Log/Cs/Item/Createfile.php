<?php
/**
 *  Admin/Log/Cs/Item/Createfile.php
 *
 *  @author     {$author}
 *  @package    Pp
 *  @version    $Id$
...
/** admin_log_cs_item_* で共通のアクションフォーム定義 */
	/*class Pp_Form_AdminLogCsItemCreatefile extends Pp_Form_AdminLogCsItem
	 {
	}*/

/**
 *  admin_log_cs_item_createfile Form implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
...
/**
 *  admin_log_cs_item_createfile action implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_Action_AdminLogCsItemCreatefile extends Pp_AdminActionClass
{
	...
	function perform()
	{
		...
		$item_log_data = $logdata_view_m->getItemLogData($search_params);
		$res = $logdata_view_m->createCsvFileItemLogData($item_log_data['data']);
		if ($res === false){
			$this->af->setApp('code', 400);
