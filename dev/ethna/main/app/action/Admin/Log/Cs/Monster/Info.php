...
/**
 *  admin_log_cs_monster_info Form implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_Form_AdminLogCsMonsterInfo extends Pp_Form_AdminLogCs
{
    /**
     *  @access private
...
/**
 *  admin_log_cs_monster_info action implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_Action_AdminLogCsMonsterInfo extends Pp_AdminActionClass
{

    /**
     *  preprocess of admin_log_cs_monster_info Action.
     *
     *  @access public
