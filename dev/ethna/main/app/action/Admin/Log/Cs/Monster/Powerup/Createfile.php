<?php
/**
 *  Admin/Log/Cs/Monster/Powerup/Createfile.php
 *
 *  @author     {$author}
 *  @package    Pp
 *  @version    $Id$
...
/**
 *  admin_log_cs_monster_powerup_createfile Form implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_Form_AdminLogCsMonsterPowerupCreatefile extends Pp_Form_AdminLogCsMonster
{
    /**
     *  @access private
...
/**
 *  admin_log_cs_monster_powerup_createfile action implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_Action_AdminLogCsMonsterPowerupCreatefile extends Pp_AdminActionClass
{
    const MAX_PAGE_DATA_COUNT = '100';
    const MAX_DATA_COUNT = '10000';

    /**
     *  preprocess of admin_log_cs_monster_powerup_createfile Action.
     *
     *  @access public
    ...
    function perform()
    {
        ...
        $res = $logdata_view_m->createCsvFilePowerupMonsterLogData($monster_powerup_log_data['data'], $item_data_list);
        if ($res === false){
            $this->af->setApp('code', 400);
