<?php
/**
 *  Admin/Log/Cs/Purchase/Createfile.php
 *
 *  @author     {$author}
 *  @package    Pp
 *  @version    $Id$
...
/*class Pp_Form_AdminLogCsPurchaseCreatefile extends Pp_Form_AdminLogCsPurchase
{
}*/

/**
 *  admin_log_cs_purchase_createfile Form implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
...
/**
 *  admin_log_cs_purchase_createfile action implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_Action_AdminLogCsPurchaseCreatefile extends Pp_AdminActionClass
{
	const MAX_PAGE_DATA_COUNT = '100';
	const MAX_DATA_COUNT = '10000';

	/**
	 *  preprocess of admin_log_cs_purchase_createfile Action.
	 *
	 *  @access public
	...
	function perform()
	{
		...
		$purchase_log_data = $logdata_view_m->getPurchaseLogData($search_params);
		$res = $logdata_view_m->createCsvFilePurchaseLogData($purchase_log_data['data']);
		if ($res === false){
			$this->af->setApp('code', 400);
