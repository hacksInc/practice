<?php
/**
 *  Admin/Log/Cs/Stress/Createfile.php
 *
 *  @author     {$author}
 *  @package    Pp
 *  @version    $Id$
...
/** admin_log_cs_stress_* で共通のアクションフォーム定義 */
	/*class Pp_Form_AdminLogCsStressCreatefile extends Pp_Form_AdminLogCsStress
	 {
	}*/

/**
 *  admin_log_cs_stress_createfile Form implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
...
/**
 *  admin_log_cs_stress_createfile action implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_Action_AdminLogCsStressCreatefile extends Pp_AdminActionClass
{
	const MAX_PAGE_DATA_COUNT = '100';
	const MAX_DATA_COUNT = '10000';

	/**
	 *  preprocess of admin_log_cs_stress_createfile Action.
	 *
	 *  @access public
	...
	function perform()
	{
		...
		$stress_log_data = $logdata_view_m->getStressLogData($search_params);
		$res = $logdata_view_m->createCsvFileStressLogData($stress_log_data['data']);
		if ($res === false){
			$this->af->setApp('code', 400);
