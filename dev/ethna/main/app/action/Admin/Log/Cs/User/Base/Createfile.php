<?php
/**
 *  Admin/Log/Cs/User/Base/Createfile.php
 *
 *  @author     {$author}
 *  @package    Pp
 *  @version    $Id$
...
/*class Pp_Form_AdminLogCsUserBaseCreatefile extends Pp_Form_AdminLogCsUser
{
}*/

/**
 *  admin_log_cs_user_base_createfile Form implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
...
/**
 *  admin_log_cs_user_base_createfile action implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_Action_AdminLogCsUserBaseCreatefile extends Pp_Action_AdminLogCsIndex
{
    ...
    /**
     *  preprocess of admin_log_cs_user_base_createfile Action.
     *
     *  @access public
    ...
    function perform()
    {
        ...
        $user_log_data = $logdata_view_m->getUserLogData($search_params);

        $res = $logdata_view_m->createCsvFileUserLogData($user_log_data['data']);
        if ($res === false){
            $this->af->setApp('code', 400);
