 ...
 *  @package    Pp
 */
class Pp_Form_AdminLogCsUserBaseIndex extends Pp_Form_AdminLogCsUser
{
    /**
     *  @access private
...
/**
 *  admin_log_cs_user_base_index action implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_Action_AdminLogCsUserBaseIndex extends Pp_Action_AdminLogCsIndex
{
    ...
    /**
     *  preprocess of admin_log_cs_user_base_index Action.
     *
     *  @access public
    ...
    function prepare()
    {
        ...
        if ($this->af->validate() > 0) {
            return 'admin_log_cs_user_base_index';
        }
    ...
    function perform()
    {
        ...
        if ($search_flg == '1'){
            ...
            if ($user_log_count == 0) {
                $this->af->setApp('user_base_log_count', 0);
                return 'admin_log_cs_user_base_index';
            }
            if ($user_log_count > $data_max_cnt) {
                $this->af->setApp('user_base_log_count', -1);
                return 'admin_log_cs_user_base_index';
            }
            ...
            $this->af->setApp('user_base_log_list', $user_log_data['data']);
            $this->af->setApp('user_base_log_count', $user_log_count);
            $this->af->setApp('user_base_log_count_2', $user_log_data['count']);
        }
        $this->af->setApp('create_file_path', '/admin/log/cs/user/base');
        return 'admin_log_cs_user_base_index';
    }
}
