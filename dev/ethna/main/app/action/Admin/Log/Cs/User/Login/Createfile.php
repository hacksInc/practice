<?php
/**
 *  Admin/Log/Cs/User/Login/Createfile.php
 *
 *  @author     {$author}
 *  @package    Pp
 *  @version    $Id$
...
/*class Pp_Form_AdminLogCsUserLoginCreatefile extends Pp_Form_AdminLogCsUser
{
}*/

/**
 *  admin_log_cs_user_login_createfile Form implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
...
/**
 *  admin_log_cs_user_login_createfile action implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_Action_AdminLogCsUserLoginCreatefile extends Pp_Action_AdminLogCsIndex
{
	...
	/**
	 *  preprocess of admin_log_cs_user_login_createfile Action.
	 *
	 *  @access public
	...
	function perform()
	{
		...
		$user_log_data = $logdata_view_m->getUserLoginLogData($search_params);

		$res = $logdata_view_m->createCsvFileUserLoginLogData($user_log_data['data']);
		if ($res === false){
			$this->af->setApp('code', 400);
