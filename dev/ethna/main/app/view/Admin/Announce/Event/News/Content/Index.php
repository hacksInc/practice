...
/**
 *  admin_announce_event_news_content_index view implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_View_AdminAnnounceEventNewsContentIndex extends Pp_AdminViewClass
{
...
//		$user_m =& $this->backend->getManager('User');
		...
		$list = $news_m->getEventNewsContentList(0, 100000, false);
