...
/**
 *  admin_announce_loginbonus_content_create_confirm view implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_View_AdminAnnounceLoginbonusContentCreateConfirm extends Pp_AdminViewClass
{
    /**
