...
/**
 *  admin_announce_loginbonus_content_create_duplicate view implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_View_AdminAnnounceLoginbonusContentCreateDuplicate extends Pp_AdminViewClass
{
    /**
