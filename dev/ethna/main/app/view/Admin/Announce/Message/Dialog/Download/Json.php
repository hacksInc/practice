<?php
/**
 *  Admin/Announce/Message/Dialog/Download/Json.php
 *
 *  @author     {$author}
 *  @package    Pp
 *  @version    $Id$
...
/**
 *  admin_announce_message_dialog_download_json view implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_View_AdminAnnounceMessageDialogDownloadJson extends Pp_AdminViewClass
{
	protected $list = null;
...
/*	
	    ...
	    $list = $message_m->getMessageDialogListForJson();
