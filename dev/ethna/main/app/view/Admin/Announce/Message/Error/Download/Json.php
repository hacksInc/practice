<?php
/**
 *  Admin/Announce/Message/Error/Download/Json.php
 *
 *  @author     {$author}
 *  @package    Pp
 *  @version    $Id$
...
/**
 *  admin_announce_message_error_download_json view implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_View_AdminAnnounceMessageErrorDownloadJson extends Pp_AdminViewClass
{
	protected $list = null;
...
/*	
	    ...
	    $list = $message_m->getMessageErrorListForJson();
