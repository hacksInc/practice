<?php
/**
 *  Admin/Announce/Message/Help/Download/Json.php
 *
 *  @author     {$author}
 *  @package    Pp
 *  @version    $Id$
...
/**
 *  admin_announce_message_help_download_json view implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_View_AdminAnnounceMessageHelpDownloadJson extends Pp_AdminViewClass
{
	protected $list = null;
...
/*	
	    ...
	    $list = $message_m->getMessageHelpListForJson();
