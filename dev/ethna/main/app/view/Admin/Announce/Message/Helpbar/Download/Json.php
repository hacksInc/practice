<?php
/**
 *  Admin/Announce/Message/Helpbar/Download/Json.php
 *
 *  @author     {$author}
 *  @package    Pp
 *  @version    $Id$
...
/**
 *  admin_announce_message_helpbar_download_json view implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_View_AdminAnnounceMessageHelpbarDownloadJson extends Pp_AdminViewClass
{
	protected $list = null;
...
/*	
	    ...
	    $list = $message_m->getMessageHelpbarListForJson();
