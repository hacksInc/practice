...
/**
 *  admin_developer_assetbundle_deploy_log_view view implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_View_AdminDeveloperAssetbundleDeployLogView extends Pp_AdminViewClass
{
    /**
