...
/**
 *  admin_developer_assetbundle_monster_create_confirm view implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_View_AdminDeveloperAssetbundleMonsterCreateConfirm extends Pp_AdminViewClass
{
    /**
