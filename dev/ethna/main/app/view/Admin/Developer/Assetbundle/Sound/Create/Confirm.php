...
/**
 *  admin_developer_assetbundle_sound_create_confirm view implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_View_AdminDeveloperAssetbundleSoundCreateConfirm extends Pp_AdminViewClass
{
    /**
