...
/**
 *  admin_developer_assetbundle_version_create_confirm view implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_View_AdminDeveloperAssetbundleVersionCreateConfirm extends Pp_AdminViewClass
{
    /**
