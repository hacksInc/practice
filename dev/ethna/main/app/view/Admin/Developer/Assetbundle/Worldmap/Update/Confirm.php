...
/**
 *  admin_developer_assetbundle_worldmap_update_confirm view implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_View_AdminDeveloperAssetbundleWorldmapUpdateConfirm extends Pp_AdminViewClass
{
    /**
