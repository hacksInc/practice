...
/**
 *  admin_developer_gacha_weight_category_create_confirm view implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_View_AdminDeveloperGachaWeightCategoryCreateConfirm extends Pp_AdminViewClass
{
