...
/**
 *  admin_developer_gacha_weightextra_category_create_input view implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_View_AdminDeveloperGachaWeightextraCategoryCreateInput extends Pp_AdminViewClass
{
