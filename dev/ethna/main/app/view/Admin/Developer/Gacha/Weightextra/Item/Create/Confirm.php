...
/**
 *  admin_developer_gacha_weightextra_item_create_confirm view implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_View_AdminDeveloperGachaWeightextraItemCreateConfirm extends Pp_AdminViewClass
{
    ...
    function preforward()
    {
		...
		$this->af->setApp('gacha_category_list', $gacha_extra_category_list);
