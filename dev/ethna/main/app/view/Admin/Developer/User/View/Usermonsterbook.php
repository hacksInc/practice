...
/**
 *  admin_developer_user_view_usermonsterbook view implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_View_AdminDeveloperUserViewUsermonsterbook extends Pp_AdminViewClass
{
    /**
...
//		$list = $developer_m->getUserList($table, $user_id);
	...
	*/
		$metadata[2]['editable'] = 0;
		$metadata2[] = $metadata[2];//遭遇日時
		$metadata[3]['editable'] = 0;
