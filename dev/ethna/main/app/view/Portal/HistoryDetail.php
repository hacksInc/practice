...
/**
 *  portal_historyDetail view implementation.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Pp
 */
class Pp_View_PortalHistoryDetail extends Pp_ViewClass
{
    /**
    ...
    function preforward()
    {
		...
		$guser = $user_m->getUserBase( $pp_id );
