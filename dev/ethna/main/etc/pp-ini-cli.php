...
$config = array(
	...
	// マスターDBのDSN
	'dsn_unit1'   => 'mysqli://admin:nd06NhpixXem@dbptpyco-master-new:3306/psychopass_game_main_unit_dev_01', // read-write
    'dsn_unit1_r' => 'mysqli://httpd:qkn84CorIqfl@dbptpyco-slave-new:3306/psychopass_game_main_unit_dev_01', // read-only
	...
	'rsync_dest' => array(
		...
		'host'	=> 'localhost',
		'rsh'	=> 'ssh',
		'home'	=> '/var/devptpyco/ethna/main/www/',
	),
	
 	// makuo実行用の情報
	'makuo' => array(
		'command_name' => 'rs_dev_deploy',
		'ssh_localhost' => 'ssh -o StrictHostKeyChecking=no -l devptpyco -i /var/devptpyco/.ssh/id_rsa localhost', // ローカルホスト接続用SSHコマンド
	),
