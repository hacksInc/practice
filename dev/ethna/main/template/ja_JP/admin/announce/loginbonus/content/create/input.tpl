...
<div class="container-fluid">
	...
	<div class="row-fluid">
        ...
        <div class="span9">
			...
			<h4>ログインボーナスID</h4>
			<input type="text" name="login_bonus_id" value="{$form.max_id}" />任意の値を入れて下さい（初期値は最大値+1）
			...
			{section name=stamp loop=10}
			
			<h4>スタンプ　{$smarty.section.stamp.index+1}日目　配布内容</h4>
				<div class="dist_type">
					<select name="dist_type{$smarty.section.stamp.index}">
						{html_options options=$app.dist_type_options selected=0}
					</select>
					&nbsp;&nbsp;&nbsp;&nbsp;配布数<input type="text" name="number{$smarty.section.stamp.index}" value="1">
					<br />
					モンスターID<input type="text" name="item_id{$smarty.section.stamp.index}" value="0">
					&nbsp;&nbsp;&nbsp;&nbsp;レベル<input type="text" name="lv{$smarty.section.stamp.index}" value="1">
					<br />
				</div>
			<br />
