        ...
        <div class="span9">
            ...
            <div class="dialog-content-box" style="margin-bottom:5px;">
                ...
                <form action="create/input" method="post">
                    <input type="submit" value="追加" class="btn btn-primary"> 新規Tipsメッセージを追加します。
                </form>
                </div>
						...
						<div style="width: 650px;">
                            <div class="row-fluid" style="margin: 10px;">
                                <dl class="dl-horizontal" style="margin: 3px;">
                                    <dt style="width:60px;">{form_name name="tip_id"}</dt>
                                    <dd style="margin-left:80px;">{$row.tip_id}</dd>
                                </dl>
                            </div>
                            <div class="row-fluid" style="margin:10px;">
                                {$row.message}
                        ...
                        <div class="row-fluid">
                            <div class="dialog-content-box" style="width: 200px;">
                                ...
                                <div style="margin:5px;">
                                    ...
                                    <input type="button" value="削除" class="btn btn-danger" id="btnDeleteMessage{$row.tip_id}" name="btn_delete_message{$row.tip_id}">
                                </div>
                                <div style="margin:5px;">
                                    <form action="create/input" method="post">
                                        <input type="hidden" name="tip_id" value="{$row.tip_id}">
...
<div id="deleteConfirmDialog">
	...
	<form action="delete/exec" method="post" id="formDeleteMessageDialog">
        <input type="hidden" name="tip_id" value="" id="deleteTipId">
	</form>
</div>
...
<script>
    ...
    $("input[name^='btn_delete_message']").click(function(){
      var name = $(this).attr('name'),
          tip_id = "";
      tip_id = name.replace('btn_delete_message', '');
      $("#deleteTipId").val(tip_id);
