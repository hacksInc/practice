...
<div class="container-fluid">
	...
	<div class="row-fluid">
        ...
        <div class="span9">
			<h2>アセットバンドル&nbsp;モンスター画像データ&nbsp;アップロードメニュー</h2>
			
			<form action="confirm" method="post" enctype="multipart/form-data" class="form-horizontal" id="form1">
				<div class="control-group">
				    <label class="control-label">
						モンスターアイコン
						<i class="icon-question-sign" data-original-title="管理画面でのみ使用するモンスターアイコンのpngファイル"></i>
					</label>
				    <div class="controls">
			    ...
			    <div class="control-group">
				    <label class="control-label">
						モンスター画像
						<i class="icon-question-sign" data-original-title="管理画面でのみ使用するモンスター画像のpngファイル"></i>
					</label>
				    <div class="controls">
