	...
	<div class="row-fluid">
        ...
        <div class="span9">
			...
			<form action="confirm" method="post" enctype="multipart/form-data" class="form-horizontal">
				<input type="hidden" name="gacha_id" value="{$app.row.gacha_id}">
				...
				<div class="row-fluid">
					...
					<div class="span4">
						<input type="hidden" name="lang" value="{$app.lang}">
						{$app.form_template.lang.option[$app.lang]}
					</div>
				</div>
				...
				<div class="text-center">
					<img src="../image?gacha_id={$app.row.gacha_id}">
				</div>
