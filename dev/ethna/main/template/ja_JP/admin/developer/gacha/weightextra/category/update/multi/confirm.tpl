...
*}
			...
			<form action="exec" method="post" style="margin-top: 10px;">
				...
				<table>
					...
					<tr>
						...
						<td>
							<div class="cell-margin">
								<input type="hidden" name="weights_float[{$i}]" value="{$row.weight_float}">
								{$row.weight_float|string_format:"%.2f"}
							</div>
						</td>
						<td>
							<div class="text-right cell-margin">
