<!DOCTYPE html>
<html lang="ja">
{include file="admin/common/head.tpl" title="ガチャモンスター操作ログ - サイコパス管理ページ"}
<body>
        ...
        <div class="span9">
			...
			<table class="table">
				...
				<tr>
					...
					<th>{$app.form_template.deck.name}</th>
				</tr>
				...
				<tr>
					...
					<td>{$row.monster_id|default:"&nbsp;"}</td>
					<td>{$row.weight_float|default:"&nbsp;"}</td>
					<td>{$row.deck|default:"&nbsp;"}</td>
				</tr>
				{/foreach}
			</table>
		</div><!--/span-->
