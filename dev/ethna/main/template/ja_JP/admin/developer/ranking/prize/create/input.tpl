		...
		<div class="span9">
			...
			<form action="confirm" method="post" class="form-horizontal">
				...
				<div class="row-fluid">
					...
					<div class="span4">
						<input class="span4" type="text" name="distribute_start" value="{$app.distribute_start}" />
					</div>
					<div class="span2">
					...
					<div class="span4">
						<input class="span4" type="text" name="distribute_end" value="{$app.distribute_end}" />
					</div>
				</div>
				<br>
				...
				<div class="row-fluid">
					...
					<div class="span4">
						<select name="prize_type" class="input-block-level">
							{html_options options=$app.prize_type_options selected=$app.prize_type}
						</select>
					</div>
					<!-- 賞品ID-->
					<div class="span2">
					...
					<div class="span4">
						<input class="span6" type="text" name="prize_id" value="{$app.prize_id}" />
					</div>
				</div>
				<br>
				...
				<div class="row-fluid">
					...
					<div class="span4">
						<input class="span4" type="text" name="lv" value="{$app.lv}" />
					</div>
				</div>
				<br>
				...
				<div class="row-fluid">
					...
					<div class="span6">
						<input class="span4" type="text" name="number" value="{$app.number}" />
					</div>
				</div>
				<br>
