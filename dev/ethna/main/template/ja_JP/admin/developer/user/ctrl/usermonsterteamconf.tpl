		...
		<div class="span9">
			...
			{foreach from=$app.monster_team key=k item=v}
				{if $v.position==1}
					...
					<form action="usermonsterteamchg" method="post">
				...
				<tr>
					...
					<td align="center">
						...
						<input type="hidden" name="leader_flag{$v.position}" value="{$v.leader}">
						<input type="hidden" name="user_monster_id{$v.position}" value="{$v.user_monster_id}">
					</td>
				...
				{if $v.position==5}
					...
					<td colspan=6 align="center">
						<input type="submit" name="update" value="変更" class="btn" />
					</td>
					</tr>
					</form>
					</table><br />
