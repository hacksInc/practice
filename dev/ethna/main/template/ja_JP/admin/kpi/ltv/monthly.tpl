<!DOCTYPE html>
<html lang="ja">
{include file="admin/common/head.tpl" title="KPI LTV（月） - サイコパス管理ページ"}
...
<div class="container-fluid">
	...
	<div class="row-fluid">
		...
		<div class="span10 main-contents">
			<div class="page-header"><h2>LTV（月）</h2></div>
			...
			<form action="monthly" method="post" class="form-horizontal" id="formLogSearch">
