<!DOCTYPE html>
<html lang="ja">
{include file="admin/common/head.tpl" title="KPI サイコハザード情報(SATGE毎) - サイコパス管理ページ"}
...
<div class="container-fluid">
	...
	<div class="row-fluid">
		...
		<div class="span4 main-contents">
			<div class="page-header"><h2>サイコハザード情報(SATGE毎)</h2></div>
			...
			<form action="stage" method="post" class="form-horizontal" id="formLogSearch">
