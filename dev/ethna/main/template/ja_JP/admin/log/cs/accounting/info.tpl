	...
	<div class="content-part-quest-info">
		<div class="content-part-quest-info-line">
			...
			<div class="content-part-quest-info-line-item">
				[{$app.accounting_log_list.0.user_id}]&nbsp;{$app.accounting_log_list.0.name}
				(Rank&nbsp;:&nbsp;{$app.accounting_log_list.0.rank})
			</div>
		</div>
		<div class="content-part-quest-info-line">
			<div class="content-part-quest-info-line-title">
			...
			<div class="content-part-quest-info-line-item">
				{$app.accounting_log_list.0.api_transaction_id}
			</div>
		</div>
		<div class="content-part-quest-info-line">
			<div class="content-part-quest-info-line-title">
			...
			<div class="content-part-quest-info-line-item">
				{$app.accounting_log_list.0.date_log}
			</div>
		</div>
		<div class="content-part-quest-info-line">
			<div class="content-part-quest-info-line-title">
			...
			<div class="content-part-quest-info-line-item">
				{$app.accounting_log_list.0.app_id}&nbsp;({$app.accounting_log_list.0.ua_name})
			</div>
		</div>
		<div class="content-part-quest-info-line">
			<div class="content-part-quest-info-line-title">
			...
			<div class="content-part-quest-info-line-item">
				{$app.accounting_log_list.0.game_transaction_id}
			</div>
		</div>
		<div class="content-part-quest-info-line">
			<div class="content-part-quest-info-line-title">
			...
			<div class="content-part-quest-info-line-item">
				{$app.accounting_log_list.0.res_flg_name}
			</div>
		</div>
		<div class="content-part-quest-info-line">
			<div class="content-part-quest-info-line-title">
			...
			<div class="content-part-quest-info-line-item">
				{$app.accounting_log_list.0.account_name}
			</div>
		</div>
	</div>
	<div style="margin-bottom:10px;">
		...
		<div class="quest-list-box">
			<div class="quest-list-content content-list-part-680">
				{$app.accounting_log_list.0.receipt}
			</div>
		</div>
	</div>
	<hr>
