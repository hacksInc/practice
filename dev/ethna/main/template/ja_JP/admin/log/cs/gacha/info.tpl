<div class="container-fluid" style="witdh: 800px;">
	<div class="dialog-title">ガチャ情報詳細</div>
	{* 検索用入力エリア *}
	<div class="content-part-quest-info">
		<div class="content-part-quest-info-line">
			...
			<div class="content-part-quest-info-line-item">
				[{$app.gacha_log_list.user_id}]&nbsp;{$app.gacha_log_list.name}
			</div>
		</div>
		<div class="content-part-quest-info-line">
			<div class="content-part-quest-info-line-title">
			...
			<div class="content-part-quest-info-line-item">
				{$app.gacha_log_list.api_transaction_id}
			</div>
		</div>
		<div class="content-part-quest-info-line">
			<div class="content-part-quest-info-line-title">
			...
			<div class="content-part-quest-info-line-item">
				{$app.gacha_log_list.date_log}&nbsp;[log_id:{$app.gacha_log_list.id}]
			</div>
		</div>
		<div class="content-part-quest-info-line">
			<div class="content-part-quest-info-line-title">
			...
			<div class="content-part-quest-info-line-item">
				[{$app.gacha_log_list.gacha_id}]{$app.gacha_log_list.gacha_name}
			</div>
		</div>
		<div class="content-part-quest-info-line">
			<div class="content-part-quest-info-line-title">
	...
	{if $app.gacha_prize_log_count!=0}
	<div>
		<div class="quest-list-box">
		...
		{* foreach from=$app.gacha_prize_log_list item="log_data" key="prize_k" *}
