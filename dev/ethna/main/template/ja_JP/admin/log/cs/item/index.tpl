<!DOCTYPE html>
<html lang="ja">
	{include file="admin/common/head.tpl" title="アイテム履歴 - サイコパス管理ページ"}
		...
		<div class="container-fluid">
			...
			<div class="row-fluid">
				...
				<div class="span9 main-contents">
					...
					{if $app.search_flg=="1"}
					{* 検索結果出力 *}
					{if $app.item_log_count==0}
					<div class="alert alert-warning">
						<span>対象となるログは存在しません</span>
					</div>
					{elseif $app.item_log_count==-1}
					...
					<div style="padding:5px;">
						<div class="search-list-title-box">
							<div>
								<span>{$app.item_log_count}件のログが抽出されました</span>
							</div>
					...
					<div>
						<div class="search-list-title-box">
							...
							<div class="search-list-title content-list-part-200">増減アイテム</div>
							<div class="search-list-title content-list-part-110">増減数</div>
							<div class="search-list-title content-list-part-110">増減後所持数</div>
						</div>
						{foreach from=$app.item_log_list key="i" item="log_data"}
						<div class="search-list-content-box">
							...
							<div class="search-list-content content-list-part-200">
								{$app.item_master_list[$log_data.item_id].name_ja}
							</div>
