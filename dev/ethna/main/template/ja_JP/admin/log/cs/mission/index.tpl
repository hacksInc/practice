<!DOCTYPE html>
<html lang="ja">
	{include file="admin/common/head.tpl" title="ミッション履歴 - サイコパス管理ページ"}
		...
		<div class="container-fluid">
			...
			<div class="row-fluid">
				...
				<div class="span9 main-contents">
					...
					{if $app.search_flg=="1"}
					{* 検索結果出力 *}
					{if $app.mission_log_count==0}
					<div class="alert alert-warning">
						<span>対象となるログは存在しません</span>
					</div>
					{elseif $app.mission_log_count==-1}
					...
					<div style="padding:5px;">
						<div class="search-list-title-box">
							<div>
								<span>{$app.mission_log_count}件のログが抽出されました</span>
							</div>
					...
					<div>
						<div class="search-list-title-box">
							<div class="search-list-title content-list-part-170">開始日時</div>
							<div class="search-list-title content-list-part-150">STAGE名</div>
							<div class="search-list-title content-list-part-150">AREA名</div>
							<div class="search-list-title content-list-part-150">MISSION名</div>
							<div class="search-list-title content-list-part-150">クリア評価</div>
						</div>
						{foreach from=$app.mission_log_list key="i" item="log_data"}
						<div class="search-list-content-box"{if $log_data.res_flg=="1"} style="width:951px;background-color:#ffaaaa;"{/if}>
							<div class="search-list-content content-list-part-170">{$log_data.start_created}</div>
							...
							<div class="search-list-content content-list-part-150">{$log_data.mission_name}</div>
							<div class="search-list-content content-list-part-150">{$log_data.result}</div>
						</div>
						{/foreach}
					</div>
					{/if}
