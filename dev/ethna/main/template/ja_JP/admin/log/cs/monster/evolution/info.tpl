<div class="container-fluid" style="witdh: 800px;">
    <div class="dialog-title">モンスター進化合成情報</div>
    {* 検索用入力エリア *}
    <div class="content-part-quest-info">
        <div class="content-part-quest-info-line">
            ...
            <div class="content-part-quest-info-line-item">
               [{$app.monster_evolution_log.user_id}]&nbsp;{$app.monster_evolution_log.name}
            </div>
        </div>
        <div class="content-part-quest-info-line">
            <div class="content-part-quest-info-line-title">
            ...
            <div class="content-part-quest-info-line-item">
               {$app.monster_evolution_log.api_transaction_id}
            </div>
        </div>
        <div class="content-part-quest-info-line">
            <div class="content-part-quest-info-line-title">
            ...
            <div class="content-part-quest-info-line-item">
                {$app.monster_evolution_log.date_log}&nbsp;[log_id:{$app.monster_evolution_log.id}]
            </div>
        </div>
    </div>
    <div style="margin-bottom:10px;">
        <div class="quest-list-box">
            <div class="quest-list-title content-list-part-100">モンスターID</div>
            <div class="quest-list-title content-list-part-200">進化前モンスター</div>
            <div class="quest-list-title content-list-part-200">進化後モンスター</div>
            <div class="quest-list-title content-list-part-150">コスト</div>
        </div>
        <div class="quest-list-box">
            <div class="quest-list-content content-list-part-100">
                {$app.monster_evolution_log.user_monster_id}<br />
            </div>
            <div class="quest-list-content content-list-part-200">
                [{$app.monster_evolution_log.old_monster_id}]&nbsp;{$app.monster_evolution_log.old_monster_name}<br />
                {$app.monster_evolution_log.old_rare}
            </div>
            <div class="quest-list-content content-list-part-200">
                [{$app.monster_evolution_log.monster_id}]&nbsp;{$app.monster_evolution_log.monster_name}<br />
                {$app.monster_evolution_log.rare}<br />
                Lv&nbsp;:&nbsp;{$app.monster_evolution_log.old_lv}&nbsp;→&nbsp;{$app.monster_evolution_log.lv}<br />
                EXP&nbsp;:&nbsp;{$app.monster_evolution_log.old_exp}&nbsp;→&nbsp;{$app.monster_evolution_log.exp}<br />
                HP&nbsp;:&nbsp;{$app.monster_evolution_log.old_hp}&nbsp;→&nbsp;{$app.monster_evolution_log.hp}<br />
                AT&nbsp;:&nbsp;{$app.monster_evolution_log.old_attack}&nbsp;→&nbsp;{$app.monster_evolution_log.attack}<br />
                SkillLv&nbsp;:&nbsp;{$app.monster_evolution_log.old_skill_lv}&nbsp;→&nbsp;{$app.monster_evolution_log.skill_lv}<br />
            </div>
            <div class="quest-list-content content-list-part-150">
                {$app.monster_evolution_log.cost}<br />
    ...
    <div>
        ...
        {if $monster_data.user_monster_id!=$app.monster_evolution_log.user_monster_id}
        <div class="quest-list-box">
            ...
            <div class="quest-list-content content-list-part-50">{$monster_data.material_exp}</div>
            <div class="quest-list-content content-list-part-50">{$monster_data.material_skill_lv}</div>
        </div>
        {/if}
        {/foreach}
    </div>
