<!DOCTYPE html>
<html lang="ja">
{include file="admin/common/head.tpl" title="モンスター履歴 - サイコパス管理ページ"}
<body>
...
{*                <div class="search-part">
            ...
            {if $app.search_flg=="1"}
                ...
                {elseif $app.monster_log_count==-1}
                ...
                <div style="padding:5px;">
                    <div class="search-list-title-box">
                        <div>
                            <span>{$app.monster_log_count}件のログが抽出されました</span>
                        </div>
                ...
                <div>
                    <div class="search-list-title-box">
                        ...
                        <div class="search-list-title content-list-part-80">生成/消滅</div>
                        <div class="search-list-title content-list-part-150">理由</div>
                    </div>
                    {foreach from=$app.monster_log_list key="i" item="log_data"}
                    <div class="search-list-content-box">
                        ...
                        <div class="search-list-content content-list-part-200">
                            ID&nbsp;:&nbsp;{$log_data.monster_id}<br />
                            [{$log_data.monster_id}]{$log_data.monster_name}<br />
                            {$log_data.rare}
                        </div>
                        <div class="search-list-content content-list-part-80">{* [{$log_data.status}] *}{$log_data.status_name}</div>
                        <div class="search-list-content content-list-part-150">{$log_data.processing_type_name}</div>
                    </div>
                    {/foreach}
                </div>
                {/if}
