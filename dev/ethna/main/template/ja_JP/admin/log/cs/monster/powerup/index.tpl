<!DOCTYPE html>
<html lang="ja">
{include file="admin/common/head.tpl" title="モンスター強化履歴 - サイコパス管理ページ"}
<body>
...
{*                <div class="search-part">
            ...
            {if $app.search_flg=="1"}
                {* 検索結果出力 *}
                {if $app.monster_powerup_log_count==0}
                <div class="alert alert-warning">
                    <span>対象となるログは存在しません</span>
                </div>
                {elseif $app.monster_powerup_log_count==-1}
                ...
                <div style="padding:5px;">
                    <div class="search-list-title-box">
                        <div>
                            <span>{$app.monster_powerup_log_count}件のログが抽出されました</span>
                        </div>
                ...
                <div>
                    <div class="search-list-title-box">
                        ...
                        <div class="search-list-title content-list-part-200">モンスター</div>
                    ...
                    {foreach from=$app.monster_powerup_log_list key="i" item="log_data"}
                    ...
                    <div class="search-list-content-box">
                        ...
                        <div class="search-list-content content-list-part-80">
                            {$log_data.cost}<br />
                            ({$item_data.old_num} → {$item_data.num})</div>
                        <div class="search-list-content content-list-part-200">
                            {$log_data.user_monster_id}<br />
                            [{$log_data.monster_id}]{$log_data.monster_name}<br />{$log_data.rare}
                        </div>
                        <div>
