<!DOCTYPE html>
<html lang="ja">
{include file="admin/common/head.tpl" title="ユーザー情報履歴 - サイコパス管理ページ"}
<body>
...
<div class="container-fluid">
    ...
    <div class="row-fluid">
        ...
        <div class="span9">
            ...
            {if $app.search_flg=="1"}
                {* 検索結果出力 *}
                {if $app.user_base_log_count==0}
                <div class="alert alert-warning">
                    <span>対象となるログは存在しません</span>
                </div>
                {elseif $app.user_base_log_count==-1}
                ...
                <div style="padding:5px;">
                    <div class="search-list-title-box">
                        <div>
                            <span>{$app.user_base_log_count}件のログが抽出されました</span>
                        </div>
                ...
                <div>
                    <div class="search-list-title-box">
                        ...
                        <div class="search-list-title content-list-part-150">uipw</div>
                        <div class="search-list-title content-list-part-150">ニックネーム</div>
                        <div class="search-list-title content-list-part-150">年齢認証</div>
                    </div>
                    {foreach from=$app.user_base_log_list key="i" item="log_data"}
                    <div class="search-list-content-box">
                        ...
                        <div>
                            <div class="content-monster-float-box">
                                <div class="search-list-content content-list-part-150">{$log_data.old_uipw_hash}</div>
                                <div class="search-list-content content-list-part-150">{$log_data.old_name}</div>
                                <div class="search-list-content content-list-part-150">
                                    {$log_data.old_age_verification_name}<br />
                                    {$log_data.old_ma_purchased_mix}
                                </div>
                            </div>
                            <div class="content-monster-float-box">
                                <div class="search-list-content content-list-part-150">{$log_data.uipw_hash}</div>
                                <div class="search-list-content content-list-part-150">{$log_data.name}</div>
                                <div class="search-list-content content-list-part-150">
                                    {$log_data.age_verification_name}<br />
                                    {$log_data.ma_purchased_mix}
                                </div>
                            </div>
                        </div>
                    </div>
