...
<div id="result">
	...
	<p id="resultText">
		投票券を<span>10</span>枚<br>交換いたしました。
	</p>
</div>

<a id="resultBackText" onClick="Unity.call('{$app.url}/psychopass_portal/content.php');">もどる</a><img id="resultBack" src="/psychopass_portal/img/portal/btn.png" width="100%">
