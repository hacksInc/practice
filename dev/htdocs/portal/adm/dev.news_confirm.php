...
//送信元チェック
if( !strpos($_SERVER['HTTP_REFERER'], "/dev.news_regist.php") && !strpos($_SERVER['HTTP_REFERER'], "/dev.news_update.php")) {
		...
		<div class="col-lg-12">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<div class="row">
						<div class="col-lg-6">
							<form role="form" method="post" action="dev.news_finish.php">
								<?php echo $msg; ?>
