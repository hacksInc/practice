...
if( !strpos($_SERVER['HTTP_REFERER'], "/dev.news_confirm.php") && !strpos($_SERVER['HTTP_REFERER'], "/dev.news_delete.php")) {
					...
					<div class="row">
						<div class="col-lg-6">
							...
							<div class="form-group">
							 ...
							 <button type="button" class="btn btn-outline btn-success" onclick="location.href='./dev.index'">一覧に戻る</button>
						</div>
						<!-- /.col-lg-6 (nested) --> 
					</div>
					<!-- /.row (nested) --> 
