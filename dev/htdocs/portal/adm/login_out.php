<?php
	...
	if($_POST['login']){
		...
		if (empty($login_id) || empty($password)) {
			...
			$db->setSql_str($sql);
			$bind_param	= $db->addBind($bind_param, "d", $login_id);
                        ...
                        <form role="form" id="login_form" method="post" action="login.php">
                            <fieldset>
                                <div class="form-group">
                                    <input class="form-control" placeholder="Login ID" name="login_id" type="text" class="required" autofocus>
                                </div>
                                <div class="form-group">
                                    <input class="form-control" placeholder="Password" name="password" type="password" class="required">
                                </div>
