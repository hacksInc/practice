...
// 		$date_fmt = $date->format('Y/m/d');
		$date_fmt	= substr($news['disp_date'], 0, 4)."/".substr($news['disp_date'], 4, 2)."/".substr($news['disp_date'], 6, 2);
		...
		$html_table .= ' 	<td><a href="news_update.php?news_id='.$news["ID"].'"><i class="fa fa-pencil fa-fw">変更</i></a>';
		$html_table .= ' 	<a href="news_delete.php?news_id='.$news["ID"].'"><i class="fa fa fa-eraser fa-fw" alt="">削除</i></a></td>';
		$html_table .= ' </tr>';
